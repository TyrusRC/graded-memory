...
from app.llm import LLMConfig, resolved_model
from app.models import AuditEntry

def run_pipeline(db: DB, root: str, cfg: LLMConfig | None = None,
                 pace: float = 4.0, resume: bool = True) -> None:
    prompts = collect(root, cfg)
    ...
    for i, p in enumerate(prompts):
        ...
        if resume and prev and prev.model == model:
            ...
            continue
        g = grade_prompt(p, cfg)   # with_retry inside handles 429s
        db.save_grading(g)
